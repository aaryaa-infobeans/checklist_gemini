...
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:81,http://localhost:3000,http://localhost,http://http://ec2-54-242-59-150.compute-1.amazonaws.com/:81,http://http://ec2-54-242-59-150.compute-1.amazonaws.com/:3000,http://http://ec2-54-242-59-150.compute-1.amazonaws.com/').split(',')
