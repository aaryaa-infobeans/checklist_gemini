...
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:81,http://localhost:3000,http://localhost,http://ec2-98-91-29-154.compute-1.amazonaws.com:81,http://ec2-98-91-29-154.compute-1.amazonaws.com:3000,http://ec2-98-91-29-154.compute-1.amazonaws.com').split(',')
